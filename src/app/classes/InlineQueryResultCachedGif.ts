...
export class InlineQueryResultCachedGif {
    ...
    public static fromJson (json) {
        return new InlineQueryResultCachedGif(
                ...
                json['gif_file_id'] ? json['gif_file_id'] : null,
    ...
    public set_gif_file_id(gif_file_id: string) {
    ...
    public toArray (deep: number = -1) {
        ...
        return {
                'type': this.get_type(),
                'id': this.get_id(),
                'gif_file_id': this.get_gif_file_id(),
