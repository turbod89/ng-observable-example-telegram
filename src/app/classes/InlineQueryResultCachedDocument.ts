...
export class InlineQueryResultCachedDocument {
    ...
    public static fromJson (json) {
        return new InlineQueryResultCachedDocument(
                ...
                json['document_file_id'] ? json['document_file_id'] : null,
    ...
    constructor (
        ...
        private document_file_id: string,
    ...
    public set_document_file_id(document_file_id: string) {
    ...
    public toArray (deep: number = -1) {
        ...
        return {
                ...
                'document_file_id': this.get_document_file_id(),
