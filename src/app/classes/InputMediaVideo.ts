export class InputMediaVideo {
    ...
    public static fromJson (json) {
        return new InputMediaVideo(
                ...
                json['supports_streaming'] ? json['supports_streaming'] : null,
        );
    }
    ...
    constructor (
        ...
        private supports_streaming: boolean = null,
    ) {}
    ...
    public set_supports_streaming(supports_streaming: boolean) {
    ...
    public toArray (deep: number = -1) {
        ...
        return {
                ...
                'supports_streaming': this.get_supports_streaming(),
        };
    }
